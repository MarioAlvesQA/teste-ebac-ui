...
describe('Feature: Login', () => {
    ...
    it('Must do login sucessfully using the file profile.json in FIXTURES folder', () => {
        ...
        cy.get('#password').type(loginprofile.password , { log: false });
    ...
    // This is Test is using the Cypress method cy.fixture() to load the profile.json file into the logindata variable
